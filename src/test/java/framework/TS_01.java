...
public class TS_01 extends Base {
	...
	public void TC_01() {
		...
		assertEquals(reg.firstname.getAttribute("value"), readExcel("TC_01"));
	}
	...
	@Test(priority = 15)
	public void TC_15() {
		String actual = reg.gender.getText();
		assertEquals(actual, "");
	}
	...
	public void TC_36() {
		reg.enterPassword("TC_31");
		reg.enterConfirmPassword("TC_36");
		pressTab();
	...
	@Test
	public void TC_38() throws InterruptedException {
		reg.enterFirstname("TC_01");
		reg.enterLastname("TC_06");
		...
		reg.enterPhoneNumber("TC_22");
		reg.enterOrg("TC_21");
		reg.selectOrgList("Saveetha Engineering College (SEC), Chennai");
		reg.enterPassword("TC_31");
		reg.enterConfirmPassword("TC_31");
		reg.register.click();
		assertEquals(reg.register.isEnabled(), false);
	}

	@Test(priority = 39, enabled = true)
	public void TC_39() throws InterruptedException {
		reg.enterFirstname("TC_01");
		reg.enterLastname("TC_06");
		reg.selectGender("male");
		reg.enterUsername("TC_11");
